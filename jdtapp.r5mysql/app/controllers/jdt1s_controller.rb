require 'b1/_global_.rb'
require 'b1common/globalfn.rb'
require 'b1common/cfn.rb'
require 'b1common/money.rb'

require 'b1/csystembusinessobject.rb'
require 'b1/ctransactionjournalobject.rb'
